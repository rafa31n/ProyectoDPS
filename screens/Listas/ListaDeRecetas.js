...
const ListaDeReceta = () => {
  ...
  const modalEditar = (item) => {
    ...
    navigation.navigate('EditListaReceta')
  }
  const agregarReceta = (item) => {
    AsyncStorage.setItem('listaRecetaID', JSON.stringify(item));
    navigation.navigate('AddRecetaLista')
  }
    ...
    AsyncStorage.getItem('listaPersonalElim')
      .then((data) => {
        if (data) {
          ...
          fetch('http://10.0.2.2:4000/api/lista_recetas', {
            method: 'PUT',
            headers: {
    ...
    AsyncStorage.getItem('datosUsuario')
      .then((data) => {
        if (data) {
          ...
          fetch("http://10.0.2.2:4000/api/lista_recetas/" + datos.userId)
      ...
      <ScrollView>
        <View style={styles.headerContainer}>
          ...
          <View style={styles.centerElement}>
            <Text style={styles.header}>Listas de recetas</Text>
          </View>
        </View>
        ...
        <View style={styles.container_body}>
          ...
          <TouchableOpacity style={styles.btnScreen}
            onPress={() => navigation.navigate("AddListaReceta")}>
            <Text style={styles.btnScreenText}>Agregar nueva lista</Text>
          </TouchableOpacity>
